...
class MMBTConfig(object):
    ...
    def __init__(self, transformer, encoder, num_labels=6, modal_hidden_size=3072): # Number of labels here: 14; remember to update JSON file; modal_hidden_size=1024
        """
